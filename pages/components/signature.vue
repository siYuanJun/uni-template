<template>
	<view class="wrapper">
		<view class="handRight"><view class="handTitle">手写板</view></view>
		<view class="handBtn">
			...
			<view class="color">
				<text>选择颜色</text>
				<image
					@click="selectColorEvent('black')"
					:src="selectColor === 'black' ? '../../static/img/color_black_selected.png' : '../../static/img/color_black.png'"
					:class="selectColor === 'black' ? 'color_select' : ''"
					class="black-select"
				></image>
				<image
					@click="selectColorEvent('red')"
					:src="selectColor === 'red' ? '../../static/img/color_red_selected.png' : '../../static/img/color_red.png'"
					:class="selectColor === 'red' ? 'color_select' : ''"
					class="red-select"
				></image>
			</view>
		</view>
