<template>
  <view class="content">
    ...
    <view class="login-body">
      ...
      <view
        class="flex justify-center align-center cu-btn bg-yellow big btnlogin"
        v-if="loginLoading"
      >
      ...
      <button
        class="cu-btn bg-yellow btnlogin"
        v-else-if="canIUse"
      ...
      <button class="cu-btn bg-yellow btnlogin" v-if="!canIUse">
        请升级微信版本
      </button>
    </view>
  </view>
