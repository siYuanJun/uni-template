<template>
	<view class="range-slider" :style="'width:' + width + 'rpx;height:' + height + 'rpx'">
		...
		<!-- <view class="block" :style="'width:' + blockSize + 'rpx;height:' + blockSize + 'rpx;margin-left:' + minBlockLeft + 'rpx;'"
		 @touchstart="_onBlockTouchStart" @touchmove.stop="_onBlockTouchMove" @touchend="_onBlockTouchEnd" :data-left="minBlockLeft"
		 data-tag="minBlock">
			<slot name="minBlock"></slot>
		</view> -->
		<view class="block" :style="'width:' + blockSize + 'rpx;height:' + blockSize + 'rpx;margin-left:' + maxBlockLeft + 'rpx;'"
		 @touchstart="_onBlockTouchStart" @touchmove.stop="_onBlockTouchMove" @touchend="_onBlockTouchEnd" :data-left="maxBlockLeft"
		 data-tag="maxBlock">
	...
	export default {
		...
		methods: {
			...
			_calculateBlockLeft: function(minValue, maxValue) {
				...
				var range = that.max - that.min;
				var minLeft = ((minValue - that.min) / range - that.min) * that.MAX_LENGTH;
